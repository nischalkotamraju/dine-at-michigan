        ...
        <View className="w-full space-y-6">
          ...
          >
            <View className="flex-row items-center">
              <View className="mr-4 h-12 w-12 items-center justify-center rounded-full bg-um-maize/10">
                <MapPin size={24} color={COLORS['um-maize']} />
              </View>
          ...
          >
            <View className="flex-row items-center">
              <View className="mr-4 h-12 w-12 items-center justify-center rounded-full bg-um-maize/10">
                <Bell size={24} color={COLORS['um-maize']} />
              </View>
              <View className="flex-1">
                <Text
                  className={cn('font-semibold text-lg', isDark ? 'text-white' : 'text-gray-900')}
